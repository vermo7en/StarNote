...
// StarNote Contract declaration inheritance the ERC721 openzeppelin implementation
contract StarNote is ERC721 {
    // Star data
    struct Star {
        string name;
    }
    ...
    string constant public name = "StarNote";
    // symbol: Is a short string like 'USD' -> 'American Dollar'
    string constant public symbol = "SN";
    ...
    function putStarUpForSale(uint256 _tokenId, uint256 _price) public {
        require(
            ...
            "cannot sell the star you don't owned"
        );
    ...
    function buyStar(uint256 _tokenId) public payable {
        require(starsForSale[_tokenId] > 0, "star should be up for sale");
        uint256 starCost = starsForSale[_tokenId];
        address ownerAddress = ownerOf(_tokenId);
        require(msg.value > starCost, "need to have enough ether");
